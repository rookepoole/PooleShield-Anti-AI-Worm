#!/usr/bin/env python3
"""
PooleShield Cycle 7 compatibility runner.
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="PooleShield v1.8 Cycle 7 clean-output review-ledger runner")
    parser.add_argument("--path", "-p", nargs="+", default=["examples/corpus_scan_fixture"], help="File/folder path(s) to scan")
    parser.add_argument("--output-dir", default="out/cycle7", help="Folder for generated reports. Defaults to out/cycle7")
    ...
    parser.add_argument("--template-csv", default="cycle7_review_ledger_template.csv", help="Editable review-ledger CSV template")
    parser.add_argument("--template-json", default="cycle7_review_ledger_template.json", help="Review-ledger template JSON")
    parser.add_argument("--template-md", default="cycle7_review_ledger_template.md", help="Review-ledger template Markdown")
    ...
    parser.add_argument("--demo-ledger-csv", default="cycle7_review_decisions_demo.csv", help="Demo review decisions CSV")
    parser.add_argument("--effective-output", default="cycle7_effective_policy_decisions.json", help="Effective decisions JSON after ledger application")
    parser.add_argument("--effective-csv", default="cycle7_effective_policy_decisions.csv", help="Effective decisions CSV")
    parser.add_argument("--effective-md", default="cycle7_effective_policy_decisions.md", help="Effective decisions Markdown")
    parser.add_argument("--allowlist", default="cycle7_allowlist.json", help="Review-generated allowlist JSON")
    parser.add_argument("--denylist", default="cycle7_denylist.json", help="Review-generated denylist JSON")
