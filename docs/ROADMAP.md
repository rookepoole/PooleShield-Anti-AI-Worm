...
- v5.3.0: Results UI with metadata table, filters, detail panel, and privacy-bundle path workflow.

## Next: v5.3.0 Baseline Manager UI
...
- v5.3.0: rule pack editor
- v5.3.0: portable Windows build
- v5.3.0: installer
- v5.2: signed release
