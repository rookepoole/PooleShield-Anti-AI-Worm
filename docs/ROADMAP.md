...
- v5.1.1: Results UI with metadata table, filters, detail panel, and privacy-bundle path workflow.

## Next: v5.1.1 Baseline Manager UI
...
- v5.1.1: rule pack editor
- v5.1.1: portable Windows build
- v5.1.1: installer
- v5.2: signed release
