# PooleShield v5.1 Baseline Manager UI Guide

PooleShield v5.1 adds the first local Baseline Manager UI on top of the v4.0 Engine API and the v4.1/v4.2 desktop prototype.
...
- does not modify the baseline file in v5.1
