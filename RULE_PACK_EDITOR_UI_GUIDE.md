# PooleShield v5.2.1 Rule Pack Editor UI Guide

PooleShield v5.2.1 adds the first local Rule Pack Editor UI on top of the v4.0 Engine API and the v4.1-v4.3 desktop UI stack.
